...
void __fastcall TForm1::Otwrz1Click(TObject *Sender)
{
   if (OpenDialog1->Execute())
   {
      ...
      {
         ShowMessage("B³¹d otwarcia pliku. Upewnij siê, ¿e plik istenije na dysku");
      }
   }
}
//---------------------------------------------------------------------------
...
{
   if (Application->MessageBox("Czy na pewno utworzyc nowy plik?", "PotwierdŸ",
...
//---------------------------------------------------------------------------
void __fastcall TForm1::Zapraszamnamojstron1Click(TObject *Sender)
{
